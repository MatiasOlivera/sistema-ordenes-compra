<template lang="html">
    ...
    <base-perfil
        :titulo="titulo"
        :nombreInstancia="tipoOrganizacion.descripcion"
        :eliminado="eliminado"
        @editar="editar"
...
import { TIPO_CLAVES }            from '../../common/components/tipo_organizacion.js';
...
export default {
    ...
    computed: {
        ...
        eliminado() {
            return _.isNull(this.tipoOrganizacion.deleted_at) ? false : true;
        }
    },
    methods: {
        editar() {
        ...
        darDeBaja() {
            apiTipoOrganizacion.darDeBaja(this.tipoOrganizacion.id)
            .then((respuesta) => {
        ...
        darDeAlta() {
            apiTipoOrganizacion.darDeAlta(this.tipoOrganizacion.id)
            .then((respuesta) => {
                const STATUS = respuesta.status;
