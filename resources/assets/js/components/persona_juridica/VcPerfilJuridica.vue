<template lang="html">
  ...
  <div>
    ...
    <!-- Empresas -->
    <vc-tarjeta-empresas
      :empresas-no-asociadas="tarjetaEmpresas.empresas"
...
export default {
  ...
  methods: {
    ...
    buscarEmpresa(valorBuscado) {
      axios
        .get(this.$options.static.url.empresas, {
          params: {
    ...
    darDeAltaEmpresa(id) {
      if (!_.isNull(id) && !_.isUndefined(id)) {
        axios
          .post(`/juridicas/${this.id}/empresas/${id}`)
          .then((response) => {
    ...
    darDeBajaEmpresa(id) {
      if (!_.isNull(id) && !_.isUndefined(id)) {
        axios
          .delete(`/juridicas/${this.id}/empresas/${id}`)
          .then((response) => {
